                    ...
                    <ul style="margin-top: 0px;">
                        <c:forEach items="${noticeCustomList}" var="n">
                            <li class="scrolltext-title">
                                <a href="${APP_PATH}/notice/${n.noticeId}" rel="bookmark">${n.noticeTitle}</a>
                            </li>
                        </c:forEach>
                    </ul>
                </div>
                ...
                <c:forEach items="${articleListVoList}" var="a">
                    ...
                    <article  class="post type-post">
                        ...
                        <figure class="thumbnail">
                            <a href="${APP_PATH}/article/${a.articleCustom.articleId}">
                                <img width="280" height="210"
                                     src="${APP_PATH}/img/thumbnail/random/img_${a.articleCustom.articleId%400}.jpg"
                                     class="attachment-content size-content wp-post-image"
                                     alt="${a.articleCustom.articleTitle}">
                            </a>
                            <span class="cat">
                                <a href="${APP_PATH}/category/${a.categoryCustomList[a.categoryCustomList.size()-1].categoryId}">
                        ...
                        <div class="entry-content">
                            ...
                            <span class="entry-meta">
                                    ...
                                    <span class="comment">&nbsp;&nbsp;
                                        <a href="${APP_PATH}/article/${a.articleCustom.articleId}#comments" rel="external nofollow">
            ...
            <nav class="navigation pagination" role="navigation">
                <div class="nav-links">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <a class="page-numbers" href="${APP_PATH}/p/${articleListVoList[0].page.pageNow-1}" >
